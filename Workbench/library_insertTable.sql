...
1, 1, 8, 9, '2022-2-10', '2022-3-1');
insert into borrowed values( 
2, 2, 7, 12, '2021-7-9', '2022/4/13');
insert into borrowed values( 
3, 3, 5, 9, '2021-9-6', '2022-4-13');
insert into borrowed values( 
4, 4, 4, 7, '2021-7-12', '2022-4-13');
insert into borrowed values( 
5, 5, 3, 8, '2022-2-20', '2022-4-13');
insert into borrowed values( 
6, 6, 2, 17, '2022-2-21', '2022-4-13');
insert into borrowed values( 
7, 7, 1, 12, '2021-8-10', '2022-4-13');
insert into borrowed values( 
8, 8, 8, 6, '2022-5-15', '2022-4-13');
insert into borrowed values( 
9, 9, 9, 14, '2021-5-31', '2022-4-13');
insert into borrowed values( 
10, 10, 8, 13, '2021-7-30', '2022-4-13');
insert into borrowed values( 
11, 11, 10, 9, '2021-9-28', '2022-4-13');
insert into borrowed values( 
12, 12, 6, 15, '2021-7-29', '2022-4-13');
insert into borrowed values( 
13, 13, 5, 14, '2021-8-11', '2022-4-13');
insert into borrowed values( 
14, 14, 4, 10, '2021-4-9', '2022-4-13');
insert into borrowed values( 
15, 15, 3, 10, '2022-8-5', '2022-4-13');
insert into borrowed values( 
16, 16, 2, 11, '2022-1-8', '2022-2-4');
insert into borrowed values( 
17, 17, 1, 8, '2021-3-12', '2022-4-13');
insert into borrowed values( 
18, 18, 7, 14, '2021-7-1', '2022-4-13');
insert into borrowed values( 
19, 19, 8, 19, '2021-8-8', '2022-4-13');
insert into borrowed values( 
20, 20, 10, 17, '2022-4-13', '2022-4-22');
